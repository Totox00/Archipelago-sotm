...
class SotmSource(IntEnum):
    ...
    RookCity = 1
    InfernalRelics = 2
    ShatteredTimelines = 3
    WrathOfTheCosmos = 4
    Vengeance = 5
    VillainsOfTheMultiverse = 6
    Oblivaeon = 7
    Unity = 8
    TheScholar = 9
    Guise = 10
    ...
    Chokepoint = 17
    SilverGulch1883 = 18
    TheFinalWasteland = 19
    OmnitronIV = 20
    TheCelestialTribunal = 21
    TheCauldron = 22
...
data = [SotmData(*row) for row in [
    # Villains
    ("Baron Blade", SotmSource.Base, SotmCategory.Villain),
    ("Mad Bomber Baron Blade", SotmSource.Base, SotmCategory.VillainVariant, "Baron Blade",
     lambda state, player: has_all_of(["Baron Blade", "Citizen Dawn"], state, player)),
    ("Citizen Dawn", SotmSource.Base, SotmCategory.Villain),
    ("Grand Warlord Voss", SotmSource.Base, SotmCategory.Villain),
    ("Omnitron", SotmSource.Base, SotmCategory.Villain),
    ("Omnitron II", SotmSource.Base, SotmCategory.VillainVariant, "Omnitron",
    ...
    ("Spite: Agent of Gloom", SotmSource.Base, SotmCategory.VillainVariant, "Spite",
    ...
    ("Skinwalker Gloomweaver", SotmSource.Base, SotmCategory.VillainVariant, "Gloomweaver",
    ...
    ("Trickster Kismet", SotmSource.Base, SotmCategory.VillainVariant, "Kismet",
    ...
    ("Heroic Infinitor", SotmSource.Base, SotmCategory.VillainVariant, "Infinitor",
    ...
    # Heroes
    ("Absolute Zero", SotmSource.Base, SotmCategory.Hero),
    ("Bunker", SotmSource.Base, SotmCategory.Hero),
    ("Fanatic", SotmSource.Base, SotmCategory.Hero),
    ("Haka", SotmSource.Base, SotmCategory.Hero),
    ("Legacy", SotmSource.Base, SotmCategory.Hero),
    ("Ra", SotmSource.Base, SotmCategory.Hero),
    ("Tachyon", SotmSource.Base, SotmCategory.Hero),
    ("Tempest", SotmSource.Base, SotmCategory.Hero),
    ("The Visionary", SotmSource.Base, SotmCategory.Hero),
    ("Wraith", SotmSource.Base, SotmCategory.Hero),
    ...
    # Environments
    ("Insula Primalis", SotmSource.Base, SotmCategory.Environment),
    ("Megalopolis", SotmSource.Base, SotmCategory.Environment),
    ("Ruins of Atlantis", SotmSource.Base, SotmCategory.Environment),
    ("Wagner Mars Base", SotmSource.Base, SotmCategory.Environment),
    ...
    ("Termi-Nation Bunker", SotmSource.Base, SotmCategory.Variant, "Bunker",
     lambda state, player: has_all_of(["Bunker", "Omnitron", "Omnitron II", "Omnitron IV"], state, player)),
    ("Termi-Nation Absolute Zero", SotmSource.Base, SotmCategory.Variant, "Absolute Zero",
    ...
    ("Freedom Six Absolute Zero", SotmSource.Base, SotmCategory.Variant, "Absolute Zero",
     lambda state, player: state.has("Absolute Zero", player) and state.has("Iron Legacy", player)),
    ("Freedom Six Bunker", SotmSource.Base, SotmCategory.Variant, "Bunker",
     lambda state, player: state.has("Bunker", player) and state.has("Iron Legacy", player)),
    ("Freedom Six Tachyon", SotmSource.Base, SotmCategory.Variant, "Tachyon",
     lambda state, player: state.has("Tachyon", player) and state.has("Iron Legacy", player)),
    ("Freedom Six Tempest", SotmSource.Base, SotmCategory.Variant, "Tempest",
     lambda state, player: state.has("Tempest", player) and state.has("Iron Legacy", player)),
    ("Freedom Six Wraith", SotmSource.Base, SotmCategory.Variant, "Wraith",
    ...
    ("Prime Wardens Captain Cosmic", SotmSource.WrathOfTheCosmos, SotmCategory.Variant, "Captain Cosmic",
     lambda state, player: has_all_of(["Prime Wardens Argent Adept", "Captain Cosmic", "Dok'Thorath Capital"],
                                      state, player)),
    ("Prime Wardens Fanatic", SotmSource.Base, SotmCategory.Variant, "Fanatic",
    ...
    ("Prime Wardens Haka", SotmSource.Base, SotmCategory.Variant, "Haka",
     lambda state, player: has_all_of(["Prime Wardens Argent Adept", "Haka", "Ambuscade"], state, player)),
    ("Prime Wardens Tempest", SotmSource.Base, SotmCategory.Variant, "Tempest",
    ...
    ("Xtreme Prime Wardens Tempest", SotmSource.Base, SotmCategory.Variant, "Tempest",
    ...
    ("Xtreme Prime Wardens Fanatic", SotmSource.Base, SotmCategory.Variant, "Fanatic",
     lambda state, player: has_all_of(["Fanatic", "The Court of Blood"], state, player)),
    ("Xtreme Prime Wardens Haka", SotmSource.Base, SotmCategory.Variant, "Haka",
     lambda state, player: has_all_of(["Haka", "Magmaria"], state, player)),
    ("Freedom Five Absolute Zero", SotmSource.Base, SotmCategory.Variant, "Absolute Zero",
     lambda state, player: freedom_five_reqs(state, player)),
    ("Freedom Five Bunker", SotmSource.Base, SotmCategory.Variant, "Bunker",
     lambda state, player: freedom_five_reqs(state, player)),
    ("Freedom Five Wraith", SotmSource.Base, SotmCategory.Variant, "Wraith",
     lambda state, player: freedom_five_reqs(state, player)),
    ("Freedom Five Tachyon", SotmSource.Base, SotmCategory.Variant, "Tachyon",
     lambda state, player: freedom_five_reqs(state, player)),
    ("Freedom Five Legacy", SotmSource.Base, SotmCategory.Variant, "Legacy",
     lambda state, player: freedom_five_reqs(state, player)),
