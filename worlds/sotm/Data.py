...
data = [SotmData(*row) for row in [
    ...
    ("Spite: Agent of Gloom", [], SotmCategory.VillainVariant, "Spite",
    ...
    ("Skinwalker Gloomweaver", [], SotmCategory.VillainVariant, "Gloomweaver",
    ...
    ("Trickster Kismet", [], SotmCategory.VillainVariant, "Kismet",
    ...
    ("Heroic Infinitor", [], SotmCategory.VillainVariant, "Infinitor",
